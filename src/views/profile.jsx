...
class Profile extends React.Component {
  ...
  loadData = () => {
    ...
    firebaseApp
      .firestore()
      .doc("profile/cSopSPOLPRvX5JMrC3Cl")
      .get()
      .then((document) => {
        this.setState({
          loading: false,
                  ...
                  <Card className="p-4">
                    <Row>
                      <Col md="4 text-center">
                        <img
                          className="preview-profile mb-2"
                          width="130px"
                          alt={this.state.profileData.image}
                          src={
          ...
          >
            <Form onSubmit={(e) => this.submit(e)}>
                    ...
                    <FormGroup>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          name="file"
                          hidden
                          onChange={(e) => this.changForm("image", e)}
                        />
                      </div>
                    </FormGroup>
                  </Col>
                  <Col md="6">
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => this.changForm("name", e)}
                        autoComplete="off"
                      />
                    </FormGroup>
                  </Col>
                  <Col md="6">
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => this.changForm("email", e)}
                        disabled
                      />
                    </FormGroup>
                  </Col>
                  <Col md="6">
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => this.changForm("gender", e)}
                      >
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) => this.changForm("phone", e)}
                        autoComplete="off"
                      />
                    </FormGroup>
                  </Col>
              ...
              <ModalFooter>
                ...
                <Button color="secondary" onClick={this.cancelToggle}>
                  Cancel
                </Button>
              </ModalFooter>
            </Form>
